...
<body>
    ...
    <div class="info">
        <cc1:tabwebcontrol id="TabWebControl1" runat="server" width="95%"><cc1:TabPage id="TabPage1" runat="server" __designer:wfdid="w32" Text="教师管理" Height="450px"></cc1:TabPage> <cc1:TabPage id="TabPage2" runat="server" __designer:wfdid="w33" Text="学生管理" Height="450px"></cc1:TabPage> <cc1:TabPage id="TabPage3" runat="server" __designer:wfdid="w34" Text="楼房数据" Height="450px"></cc1:TabPage> </cc1:tabwebcontrol>
