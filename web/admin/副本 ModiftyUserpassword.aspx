<%@ Page Language="C#" AutoEventWireup="true" CodeFile="副本 ModiftyUserpassword.aspx.cs" Inherits="admin_ModiftyUserpassword" %>
...
<head runat="server">
    ...
    function che()
    {
        ...
        if(oldpassword.value.length==0||newpassword.value.length==0||check.value.length==0)
        {
           alert('请填写完整信息');
           return false;
        }
...
<body style="font-size:12px;">
    ...
    <div style="width:100%; height:auto; margin-top:100px; margin-left:auto; margin-right:auto;">
      ...
      <div style="width:150px; float:left; margin-left:10px; height:30px;">
          <asp:TextBox ID="oldpassword" runat="server" TextMode="Password"></asp:TextBox></div>
